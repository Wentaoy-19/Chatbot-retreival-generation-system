...
class T5ModelTRTConfig(NNConfig):
    ...
    TARGET_MODELS = ["t5-small", "t5-base", "t5-large", "t5-3b","google/flan-t5-small","google/flan-t5-large"]
    NUMBER_OF_LAYERS = {TARGET_MODELS[0]: 6, TARGET_MODELS[1]: 12, TARGET_MODELS[2]: 24, TARGET_MODELS[3]: 24,TARGET_MODELS[4]: 8,TARGET_MODELS[5]: 24}
    MAX_SEQUENCE_LENGTH = {
        TARGET_MODELS[0]: 512,
        TARGET_MODELS[1]: 768,
